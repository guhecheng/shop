        ...
        <div class="coupons-item" style="background-image:url('/images/coupon.png')" data-id="" data-type="">
            ...
            <div class="coupons-right">
                <div class="coupons-right-1">
                    <div style="font-size:0.8rem;">使用该券可享受@if ($coupon->type == 0)普通@elseif ($coupon->type == 1)黄金@elseif($coupon->type == 2)铂金@elseif ($coupon->type == 3)钻石@endif会员同等折扣1次</div>
                </div>
                ...
                <div class="copuon-right-2">
                    ...
                    <div style="margin-left:10%;">已分享给用户{{ $coupon->recv_uname }}领取</div>
                    @else
