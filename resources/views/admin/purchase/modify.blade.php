        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form enctype="multipart/form-data" method="post" role="form" action="/admin/purchase/mod" onsubmit="return checkform()">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="goodsname" class="col-sm-2 control-label">商品名 <span class="is_must">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="goodsname" name="goodsname" placeholder="请输入名字" value="{{ $purchase->goods_name }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="goodsprice" name="goodsprice" placeholder="请输入价格（元)" value="{{ $purchase->price / 100 }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="price" class="col-sm-2 control-label">原价</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="act_price" name="act_price" placeholder="请输入价格（元)" value="{{ $purchase->act_price / 100 }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <script id="container" name="content" type="text/plain"><?php echo htmlspecialchars_decode($purchase->goodsdesc);?></script>
                                </div>
                            </div>
                            <div class="form-group">
